...
with open('../Modelos/model_usa.sav', 'rb') as file:
    model = pickle.load(file)

# Load DataFrame with distances
distances_df = pd.read_pickle('../Datos_cache/df_usa_millas.pkl') 
...
aerolineas = ['Copa Airlines', 'LATAM Airlines', 'Delta', 'Avianca', 'JetSMART',
              ...
              'Aerolineas Argentinas', 'Hahn Air', 'WestJet', 'British Airways',
              'KLM', 'Air France', 'Qantas Airways']

st.title("Bienvenido")
st.text("Tu estimador de pasajes para salir de Santiago a Estados Unidos ")
